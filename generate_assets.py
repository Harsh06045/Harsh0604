...
def build_terminal():
    ...
    lines.append('<text x="450" y="57" text-anchor="middle" fill="#8b949e" font-size="13" font-family="ui-monospace,monospace">~/harsh-kumar-portfolio</text>')
    ...
    sections = [
        ("----------------------------------------------------", "#30363d", 122),
        ("Name:     Harsh Kumar",                               "#e6edf3", 140),
        ("Role:     Software Engineer • Full Stack Developer",   "#00ffcc", 158),
        ("Stack:    Java • DSA (300+) • React • Node • AI/ML",   "#8b949e", 176),
        ("Location: Anand, Gujarat — 388001",                   "#8b949e", 194),
        ("Education: BE in CSE (Sathyabama Univ) • 8.33 CGPA",  "#8b949e", 212),
        ("Awards:   Hackathon Winner • Startup Fest Presenter", "#febc2e", 230),
        ("Motto:    Learn → Build → Debug → Improve → Repeat",   "#39d353", 248),
        ("----------------------------------------------------", "#30363d", 266),
    ]
